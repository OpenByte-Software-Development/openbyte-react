...
export const FAQS = [
  {
    ...
    answer: (
      <span>
        ...
        with our customers.
        <br /> <br /> Check out our
        <span className="text-orange">Portfolio</span> to learn more about our
        clients and the projects we’ve delivered.
      </span>
    ),
  },
  {
  ...
  },
  {
    ...
    answer: (
      <span>
        ...
        <span className="text-orange">hi@openbyte.dev</span>
      </span>
    ),
  },
  {
...
export const CLIENTS_REVIEWS = [
  {
    avatar: "https://ui-avatars.com/api/?name=Victor+Bivol",
    name: "Victor Bivol",
    company: "Orange, PM",
    position: "CEO",
    review:
