    ...
    <Layout>
      <div className="container">
        <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          ...
          <div className="text-left text-gray-800 mt-3">
            <p>
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to ELITIV GROUP
                  S.R.L, 31 August 1989 St 78, Chișinău 2012.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to OpenByte, accessible from
                  <a
            ...
            <ul>
              <li>
                <p>By email: radu.bordei89@gmail.com</p>
              </li>
              <li>
                <p>
                  By visiting this page on our website:
                  <a
                    href="https://openbyte.dev/contact"
                    rel="noreferrer"
                    target="_blank"
                  >
                    https://openbyte.dev/contact
                  </a>
                </p>
              </li>
              <li>
                <p>By phone number: +37369060613</p>
              </li>
            </ul>
          </div>
        </div>
